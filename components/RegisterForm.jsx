    ...
    >
      ...
      <div>
        ...
        <input
          ...
          autoComplete="name"
          className="h-12 w-full rounded-2xl border border-[#E5DDE0] bg-[#FCFAFB] px-4 text-right text-sm text-black outline-none transition focus:border-[#D96C8A] focus:ring-2 focus:ring-[#D96C8A]/10"
        />
